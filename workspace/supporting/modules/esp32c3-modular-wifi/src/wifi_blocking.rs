//! ESP32-C3 WiFi Blocking Module - Sequential Implementation
//! 
//! Provides WiFi connectivity using blocking operations and simple helper functions.
//! This is the default implementation that can be swapped with wifi_embassy.rs
//! 
//! ## Implementation Characteristics:
//! - **Blocking operations**: Uses busy-wait loops and simple delays
//! - **Sequential execution**: One operation at a time, predictable flow
//! - **Simple API**: Function-based approach without complex lifetimes
//! - **Low complexity**: Easy to understand and debug
//! 
//! ## Usage:
//! This module is selected by default. To use this implementation:
//! ```bash
//! cargo run --release  # Uses blocking implementation by default
//! ```
//! 
//! ## Integration with MQTT:
//! This blocking approach works well with simple MQTT clients that don't
//! require concurrent operations. For concurrent WiFi + MQTT operations,
//! consider using wifi_embassy.rs instead.
